          ...
          <div className="lg:col-span-3 p-4 flex flex-col justify-between">
            ...
            <div className="booking grid sm:grid-cols-2 grid-cols-1  mt-8">
              ...
              <div className="btn text-end">
                <button onClick={bookNow} className="px-4 py-2 sm:w-auto w-full sm:m-0 mt-2  font-bold rounded-full bg-main border-main hover:text-main duration-700 border-2 text-white hover:bg-transparent">
                  {t("Book Now")}
                </button>
                <button
                  onClick={handleClick}
