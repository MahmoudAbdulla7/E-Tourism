...
<label className="relative inline-flex items-center cursor-pointer my-2">
        <input onChange={handleCheckboxChange} type="checkbox" className="sr-only peer" />
        ...
        <p className="font-medium text-lg text-main ms-2">Filter Tickets By Current Day</p>
      </label>
</div>
    </div>
